<template>
  <div class="home">
    <div class="container mx-auto">
      <div
        class="w-1/2 mx-auto my-8 rounded-lg bg-white"
        v-for="(post, index) of friendsPost"
        :key="post.id"
      >
        <div class="p-3">
          <p class="font-semibold">{{ post.user_email }}</p>
          <p>{{ post.createdAt }}</p>
        </div>
    ...
    <div class="fixed top-40 right-5">
      ...
      >
        ...
        <i
          ...
          class="fa-solid fa-plus hover:cursor-pointer"
        ></i>
      </div>
    </div>
  </div>
